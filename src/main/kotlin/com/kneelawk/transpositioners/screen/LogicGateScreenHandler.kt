...
class LogicGateScreenHandler(
    syncId: Int, playerInventory: PlayerInventory, override val module: LogicGateModule
) : SyncedGuiDescription(TPScreenHandlers.LOGIC_GATE_TYPE, syncId, playerInventory, module.gates, null), ModuleScreenHandler {
    companion object {
        private val LOGGER = LogManager.getLogger()

        private val NET_PARENT = McNetworkStack.SCREEN_HANDLER.subType(
            LogicGateScreenHandler::class.java, str("logic_gate_screen_handler")
        )
    ...
    init {
        ...
        val gateCount = LogicGateModule.gateCountByMk(module.mk)
